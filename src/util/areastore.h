...
struct Area {
	...
	Area(const v3size &mine, const v3size &maxe, u32 area_id = U32_MAX) :
...
public:
	...
	void getAreasForPos(std::vector<Area *> *result, v3size pos);
	...
	virtual void getAreasInArea(std::vector<Area *> *result,
		v3size minedge, v3size maxedge, bool accept_overlap) = 0;
...
protected:
	...
	virtual void getAreasForPosImpl(std::vector<Area *> *result, v3size pos) = 0;
...
private:
	...
	static void cacheMiss(void *data, const v3size &mpos, std::vector<Area *> *dest);
	...
	LRUCache<v3size, std::vector<Area *> > m_res_cache;
};
...
protected:
	virtual void getAreasForPosImpl(std::vector<Area *> *result, v3size pos);
