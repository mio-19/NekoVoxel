...
std::vector<v3size> NodeMetadataList::getAllKeys()
{
	std::vector<v3size> keys;
...
NodeMetadata *NodeMetadataList::get(v3size p)
{
...
void NodeMetadataList::remove(v3size p)
{
...
void NodeMetadataList::set(v3size p, NodeMetadata *d)
{
	remove(p);
	m_data.emplace(p, d);
}
