...
std::vector<v3s32> NodeMetadataList::getAllKeys()
{
	std::vector<v3s32> keys;
...
NodeMetadata *NodeMetadataList::get(v3s32 p)
{
...
void NodeMetadataList::remove(v3s32 p)
{
...
void NodeMetadataList::set(v3s32 p, NodeMetadata *d)
{
	remove(p);
	m_data.emplace(p, d);
}
