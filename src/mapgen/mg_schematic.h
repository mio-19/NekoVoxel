...
public:
	...
	bool getSchematicFromMap(Map *map, v3size p1, v3size p2);
	...
	void blitToVManip(MMVManip *vm, v3size p, Rotation rot, bool force_place);
	bool placeOnVManip(MMVManip *vm, v3size p, u32 flags, Rotation rot, bool force_place);
	void placeOnMap(ServerMap *map, v3size p, u32 flags, Rotation rot, bool force_place);
