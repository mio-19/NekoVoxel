...
public:
	...
	s32 clust_num_ores; // how many ore nodes are in a chunk
	s32 clust_size;     // how large (in nodes) a chunk of ore is
	s32 y_min;
	s32 y_max;
	...
	size_t placeOre(Mapgen *mg, u32 blockseed, v3s32 nmin, v3s32 nmax);
	virtual void generate(MMVManip *vm, int mapseed, u32 blockseed,
		v3s32 nmin, v3s32 nmax, biome_t *biomemap) = 0;
...
public:
	...
	void generate(MMVManip *vm, int mapseed, u32 blockseed,
			v3s32 nmin, v3s32 nmax, biome_t *biomemap) override;
};
...
public:
	...
	size_t placeAllOres(Mapgen *mg, u32 blockseed, v3s32 nmin, v3s32 nmax);
