...
struct DungeonParams {
	...
	v3s32 room_size_large_min;
	v3s32 room_size_large_max;
...
public:
	...
	void generate(MMVManip *vm, u32 bseed, v3s32 full_node_min, v3s32 full_node_max);

	void makeDungeon(v3s32 start_padding);
	void makeRoom(v3s32 roomsize, v3s32 roomplace);
	void makeCorridor(v3s32 doorplace, v3s32 doordir,
		v3s32 &result_place, v3s32 &result_dir);
	void makeDoor(v3s32 doorplace, v3s32 doordir);
	void makeFill(v3s32 place, v3s32 size, u8 avoid_flags, MapNode n, u8 or_flags);
	void makeHole(v3s32 place);

	bool findPlaceForDoor(v3s32 &result_place, v3s32 &result_dir);
	bool findPlaceForRoomDoor(v3s32 roomsize, v3s32 &result_doorplace,
