...
MapgenCarpathianParams::MapgenCarpathianParams():
	np_filler_depth  (0,   1,   v3d(128,  128,  128),  261,   3, 0.7,  2.0),
	np_height1       (0,   5,   v3d(251,  251,  251),  9613,  5, 0.5,  2.0),
	np_height2       (0,   5,   v3d(383,  383,  383),  1949,  5, 0.5,  2.0),
	np_height3       (0,   5,   v3d(509,  509,  509),  3211,  5, 0.5,  2.0),
	np_height4       (0,   5,   v3d(631,  631,  631),  1583,  5, 0.5,  2.0),
	np_hills_terrain (1,   1,   v3d(1301, 1301, 1301), 1692,  5, 0.5,  2.0),
	np_ridge_terrain (1,   1,   v3d(1889, 1889, 1889), 3568,  5, 0.5,  2.0),
	np_step_terrain  (1,   1,   v3d(1889, 1889, 1889), 4157,  5, 0.5,  2.0),
	np_hills         (0,   3,   v3d(257,  257,  257),  6604,  6, 0.5,  2.0),
	np_ridge_mnt     (0,   12,  v3d(743,  743,  743),  5520,  6, 0.7,  2.0),
	np_step_mnt      (0,   8,   v3d(509,  509,  509),  2590,  6, 0.6,  2.0),
	np_rivers        (0,   1,   v3d(1000, 1000, 1000), 85039, 5, 0.6,  2.0),
	np_mnt_var       (0,   1,   v3d(499,  499,  499),  2490,  5, 0.55, 2.0),
	np_cave1         (0,   12,  v3d(61,   61,   61),   52534, 3, 0.5,  2.0),
	np_cave2         (0,   12,  v3d(67,   67,   67),   10325, 3, 0.5,  2.0),
	np_cavern        (0,   1,   v3d(384,  128,  384),  723,   5, 0.63, 2.0),
...
void MapgenCarpathianParams::readParams(const Settings *settings)
{
	...
	settings->getS32NoEx("mgcarpathian_large_cave_depth",     large_cave_depth);
	...
	settings->getS32NoEx("mgcarpathian_cavern_limit",         cavern_limit);
	settings->getS32NoEx("mgcarpathian_cavern_taper",         cavern_taper);
	settings->getFloatNoEx("mgcarpathian_cavern_threshold",   cavern_threshold);
	settings->getS32NoEx("mgcarpathian_dungeon_ymin",         dungeon_ymin);
	settings->getS32NoEx("mgcarpathian_dungeon_ymax",         dungeon_ymax);
...
void MapgenCarpathianParams::writeParams(Settings *settings) const
{
	...
	settings->setS32("mgcarpathian_large_cave_depth",     large_cave_depth);
	...
	settings->setS32("mgcarpathian_cavern_limit",         cavern_limit);
	settings->setS32("mgcarpathian_cavern_taper",         cavern_taper);
	settings->setFloat("mgcarpathian_cavern_threshold",   cavern_threshold);
	settings->setS32("mgcarpathian_dungeon_ymin",         dungeon_ymin);
	settings->setS32("mgcarpathian_dungeon_ymax",         dungeon_ymax);
...
int MapgenCarpathian::getSpawnLevelAtPoint(v2s32 p)
{
	...
	for (s32 y = water_level; y <= water_level + 32; y++) {
