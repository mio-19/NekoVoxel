 ...
 */
bool boxLineCollision(const aabb3f &box, const v3d &start, const v3d &dir,
	v3d *collision_point, v3d *collision_normal);

bool boxLineCollision(const aabb3f &box, const v3d &box_rotation,
