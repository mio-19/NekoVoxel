...
bool MeshUpdateQueue::addBlock(Map *map, v3s32 p, bool ack_block_to_server, bool urgent)
{
...
void MeshUpdateQueue::done(v3s32 pos)
{
	MutexAutoLock lock(m_mutex);
...
MeshUpdateWorkerThread::MeshUpdateWorkerThread(MeshUpdateQueue *queue_in, MeshUpdateManager *manager, v3s32 *camera_offset) :
...
void MeshUpdateManager::updateBlock(Map *map, v3s32 p, bool ack_block_to_server,
