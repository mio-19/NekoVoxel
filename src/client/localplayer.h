...
public:
	...
	v3size getStandingNodePos();
	v3size getFootstepNodePos();
...
private:
	...
	v3f m_position;
	v3size m_standing_node;

	v3size m_sneak_node = v3size(32767, 32767, 32767);
	...
	// and its old type
	v3size m_old_node_below = v3size(32767, 32767, 32767);
