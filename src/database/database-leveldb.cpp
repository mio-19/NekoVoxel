...
bool Database_LevelDB::saveBlock(const v3size &pos, const std::string &data)
{
...
void Database_LevelDB::loadBlock(const v3size &pos, std::string *block)
{
...
bool Database_LevelDB::deleteBlock(const v3size &pos)
{
...
void Database_LevelDB::listAllLoadableBlocks(std::vector<v3size> &dst)
{
