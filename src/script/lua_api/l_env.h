...
public:
	LuaABM(lua_State *L, int id,
			...
			float trigger_interval, u32 trigger_chance, bool simple_catch_up, s32 min_y, s32 max_y):
		m_id(id),
...
public:
	...
	virtual void trigger(ServerEnvironment *env, v3s32 p, MapNode n, float dtime_s);
};
