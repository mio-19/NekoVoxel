...
struct RollbackNode
{
	...
	RollbackNode(Map *map, v3size p, IGameDef *gamedef);
};
...
struct RollbackAction
{
	...
	void setSetNode(v3size p_, const RollbackNode &n_old_,
	...
	bool getPosition(v3size *dst) const;
...
public:
	...
	virtual std::string getSuspect(v3size p, float nearness_shortcut,
	...
	// <seconds> in history
	virtual std::list<RollbackAction> getNodeActors(v3size pos, int range,
