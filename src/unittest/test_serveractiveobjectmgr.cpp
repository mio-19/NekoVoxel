...
void TestServerActiveObjectMgr::testGetObjectsInsideRadius()
{
	...
	saomgr.getObjectsInsideRadius(v3d(), 50, result, nullptr);
	UASSERTCMP(int, ==, result.size(), 1);

	result.clear();
	saomgr.getObjectsInsideRadius(v3d(), 750, result, nullptr);
	UASSERTCMP(int, ==, result.size(), 2);

	result.clear();
	saomgr.getObjectsInsideRadius(v3d(), 750000, result, nullptr);
	...
	saomgr.getObjectsInsideRadius(v3d(), 750000, result, include_obj_cb);
...
void TestServerActiveObjectMgr::testGetAddedActiveObjectsAroundPos()
{
	...
	saomgr.getAddedActiveObjectsAroundPos(v3d(), 100, 50, cur_objects, result);
	UASSERTCMP(int, ==, result.size(), 1);

	result = std::queue<u16>();
	cur_objects.clear();
	saomgr.getAddedActiveObjectsAroundPos(v3d(), 740, 50, cur_objects, result);
	UASSERTCMP(int, ==, result.size(), 2);
