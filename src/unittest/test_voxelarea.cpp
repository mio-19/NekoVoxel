...
{
	VoxelArea v1(v3s32(-1447, 8854, -875), v3s32(-147, -9547, 669));
	VoxelArea v2(v3s32(-887, 4445, -5478), v3s32(447, -8779, 4778));

	v1.addArea(v2);
	UASSERT(v1.MinEdge == v3s32(-1447, 4445, -5478));
	UASSERT(v1.MaxEdge == v3s32(447, -8779, 4778));
}

void TestVoxelArea::test_pad()
{
	VoxelArea v1(v3s32(-1447, 8854, -875), v3s32(-147, -9547, 669));
	v1.pad(v3s32(100, 200, 300));

	UASSERT(v1.MinEdge == v3s32(-1547, 8654, -1175));
	UASSERT(v1.MaxEdge == v3s32(-47, -9347, 969));
}

void TestVoxelArea::test_extent()
{
	VoxelArea v1(v3s32(-1337, -547, -789), v3s32(-147, 447, 669));
	UASSERT(v1.getExtent() == v3s32(1191, 995, 1459));

	VoxelArea v2(v3s32(32493, -32507, 32752), v3s32(32508, -32492, 32767));
...
{
	VoxelArea v1(v3s32(-1337, -9547, -789), v3s32(-147, 750, 669));
	UASSERTEQ(bool, v1.contains(VoxelArea(v3s32(-200, 10, 10), v3s32(-150, 10, 10))),
			true);
	UASSERTEQ(bool, v1.contains(VoxelArea(v3s32(-2550, 10, 10), v3s32(10, 10, 10))),
			false);
	UASSERTEQ(bool, v1.contains(VoxelArea(v3s32(-10, 10, 10), v3s32(3500, 10, 10))),
			false);
	UASSERTEQ(bool,
			v1.contains(VoxelArea(
					v3s32(-800, -400, 669), v3s32(-500, 200, 669))),
			true);
	UASSERTEQ(bool,
			v1.contains(VoxelArea(
					v3s32(-800, -400, 670), v3s32(-500, 200, 670))),
			false);
}
...
{
	VoxelArea v1(v3s32(-1337, -9547, -789), v3s32(-147, 750, 669));
	UASSERTEQ(bool, v1.contains(v3s32(-200, 10, 10)), true);
	UASSERTEQ(bool, v1.contains(v3s32(-10000, 10, 10)), false);
	UASSERTEQ(bool, v1.contains(v3s32(-100, 10000, 10)), false);
	UASSERTEQ(bool, v1.contains(v3s32(-100, 100, 10000)), false);
	UASSERTEQ(bool, v1.contains(v3s32(-100, 100, -10000)), false);
	UASSERTEQ(bool, v1.contains(v3s32(10000, 100, 10)), false);
}
...
void TestVoxelArea::test_contains_i()
{
	...
	VoxelArea v2(v3s32(10, 10, 10), v3s32(30, 30, 30));
...
{
	VoxelArea v1(v3s32(-1337, -9547, -789), v3s32(-147, 750, 669));
	UASSERTEQ(bool, v1 == VoxelArea(v3s32(-1337, -9547, -789), v3s32(-147, 750, 669)),
			true);
	UASSERTEQ(bool, v1 == VoxelArea(v3s32(0, 0, 0), v3s32(-147, 750, 669)), false);
	UASSERTEQ(bool, v1 == VoxelArea(v3s32(0, 0, 0), v3s32(-147, 750, 669)), false);
	UASSERTEQ(bool, v1 == VoxelArea(v3s32(0, 0, 0), v3s32(0, 0, 0)), false);
}

void TestVoxelArea::test_plus()
{
	VoxelArea v1(v3s32(-10, -10, -10), v3s32(100, 100, 100));
	UASSERT(v1 + v3s32(10, 0, 0) ==
			VoxelArea(v3s32(0, -10, -10), v3s32(110, 100, 100)));
	UASSERT(v1 + v3s32(10, -10, 0) ==
			VoxelArea(v3s32(0, -20, -10), v3s32(110, 90, 100)));
	UASSERT(v1 + v3s32(0, 0, 35) ==
			VoxelArea(v3s32(-10, -10, 25), v3s32(100, 100, 135)));
}
...
void TestVoxelArea::test_minor()
{
	VoxelArea v1(v3s32(-10, -10, -10), v3s32(100, 100, 100));
	UASSERT(v1 - v3s32(10, 0, 0) ==
			VoxelArea(v3s32(-20, -10, -10), v3s32(90, 100, 100)));
	UASSERT(v1 - v3s32(10, -10, 0) ==
			VoxelArea(v3s32(-20, 0, -10), v3s32(90, 110, 100)));
	UASSERT(v1 - v3s32(0, 0, 35) ==
			VoxelArea(v3s32(-10, -10, -45), v3s32(100, 100, 65)));
}
...
void TestVoxelArea::test_index_xyz_all_pos()
{
	...
	VoxelArea v2(v3s32(756, 8854, -875), v3s32(-147, -9547, 669));
...
{
	VoxelArea v1;
	UASSERTEQ(s32, v1.index(v3s32(156, 25, 236)), 155);

	VoxelArea v2(v3s32(756, 8854, -875), v3s32(-147, -9547, 669));
	UASSERTEQ(s32, v2.index(v3s32(156, 25, 236)), 1267138774);
}

void TestVoxelArea::test_index_v3s16_x_neg()
{
	VoxelArea v1;
	UASSERTEQ(s32, v1.index(v3s32(-147, 25, 366)), -148);

	VoxelArea v2(v3s32(756, 8854, -875), v3s32(-147, -9547, 669));
	UASSERTEQ(s32, v2.index(v3s32(-147, 25, 366)), -870244825);
}

void TestVoxelArea::test_index_v3s16_y_neg()
{
	VoxelArea v1;
	UASSERTEQ(s32, v1.index(v3s32(247, -269, 100)), 246);

	VoxelArea v2(v3s32(756, 8854, -875), v3s32(-147, -9547, 669));
	UASSERTEQ(s32, v2.index(v3s32(247, -269, 100)), -989760747);
}

void TestVoxelArea::test_index_v3s16_z_neg()
{
	VoxelArea v1;
	UASSERTEQ(s32, v1.index(v3s32(244, 336, -887)), 243);

	VoxelArea v2(v3s32(756, 8854, -875), v3s32(-147, -9547, 669));
	UASSERTEQ(s32, v2.index(v3s32(244, 336, -887)), -191478876);
}

void TestVoxelArea::test_index_v3s16_xy_neg()
{
	VoxelArea v1;
	UASSERTEQ(s32, v1.index(v3s32(-365, -47, 6978)), -366);

	VoxelArea v2(v3s32(756, 8854, -875), v3s32(-147, -9547, 669));
	UASSERTEQ(s32, v2.index(v3s32(-365, -47, 6978)), 1493679101);
}

void TestVoxelArea::test_index_v3s16_yz_neg()
{
	VoxelArea v1;
	UASSERTEQ(s32, v1.index(v3s32(66, -58, -789)), 65);

	VoxelArea v2(v3s32(756, 8854, -875), v3s32(-147, -9547, 669));
	UASSERTEQ(s32, v2.index(v3s32(66, -58, -789)), 1435362734);
}

void TestVoxelArea::test_index_v3s16_xz_neg()
{
	VoxelArea v1;
	UASSERTEQ(s32, v1.index(v3s32(-36, 589, -992)), -37);

	VoxelArea v2(v3s32(756, 8854, -875), v3s32(-147, -9547, 669));
	UASSERTEQ(s32, v2.index(v3s32(-36, 589, -992)), -1934371362);
}

void TestVoxelArea::test_index_v3s16_all_neg()
{
	VoxelArea v1;
	UASSERTEQ(s32, v1.index(v3s32(-88, -99, -1474)), -89);

	VoxelArea v2(v3s32(756, 8854, -875), v3s32(-147, -9547, 669));
	UASSERTEQ(s32, v2.index(v3s32(-88, -99, -1474)), -1343473846);
}
